...
public class EMF_Creator {
    ...
    /*
     * Call this method in your @AfterAll method if startREST_TestWithDB() was
     * previously called
     */
    ...
    private static EntityManagerFactory createEntityManagerFactory(boolean isTest) {
         ...
         */
        String puName = isTest || System.getProperty("IS_INTEGRATION_TEST_WITH_DB") != null ? "puTest" : "pu"; // Only
                                                                                                               // legal
                                                                                                               // names
